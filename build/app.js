...
var Palette = React.createClass({displayName: "Palette",
  ...
  _listPalettes: function() {
    ...
    return allPalettes.map(function(item) {
      return (
        React.createElement("div", {className: "palette", "data-js": item.id}, 
          React.createElement("a", {href: '/palettes/' + item.id}, 
            React.createElement("h3", null, item.title)
          ), 
          React.createElement("p", null, item.category), 
          React.createElement("div", {className: "colorContainer"}, 
  ...
  _listPaletteColors: function(p) {
    ...
    var paletteColours = colourKeys.map(function(colKey, i) {
      return (
        React.createElement("div", {className: "color", key: p.id + colKey, style: {backgroundColor: p.colours[colKey]}}, 
          React.createElement("div", {className: "hex", style: {color: p.colours[colKey]}}, p.colours[colKey])
        )
      )
    });
    return (
  ...
  render: function() {
    return (
      ...
      this.props.palettes.map(function(item) {
        return React.createElement(Palette, {palette: item, key: item})
      })
      )
    )
  }
